...
CREATE TABLE `watchlists` (
  ...
  `NombreLista` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `UserId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`WatchlistId`),
  KEY `IX_Watchlists_UserId` (`UserId`),
  CONSTRAINT `FK_Watchlists_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`)
